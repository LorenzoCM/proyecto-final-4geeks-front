            ...
            <div className="container mt-5 py-4 text-center">
                <div className="row">
                    <div className="col-md-12 col-sm-10 col-10 mx-auto suscribe-box">
                        ...
                        <div className="input-group mb-3 suscribe mt-4  mx-auto">
                            <input type="text" className="form-control col-sm-8" placeholder="Ingrese su email" aria-label="Recipient's username" aria-describedby="basic-addon2" />
                            <div className="input-group-append">
                                <span className="input-group-text" id="basic-addon2">Suscribirme</span>
                            </div>
                        </div>
                    </div>
                </div>
