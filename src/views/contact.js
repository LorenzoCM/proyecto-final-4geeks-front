        ...
        <div className="container text-center my-5">
            <div className="row">
                <div className="col-sm-12 col-xs-10">
                    ...
                    <img className="img-fluid" width="100%" src="https://s1.eestatic.com/2017/02/13/cocinillas/Cocinillas_193495389_116293002_1024x576.jpg" className="" alt="..." />
                    ...
                    <div className="contact-form col-md-7 py-5">
                        <div className="form-row">
                            <div className="form-group col-md-6">
                                ...
                                <input type="email" className="form-control" id="inputEmail4" placeholder="Nombre y apellido" />
                            </div>
                            <div className="form-group col-md-6">
