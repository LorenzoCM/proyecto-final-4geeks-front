                                        ...
                                        store.products.map((product, index) => {
                                            return (
                                                <tr>
                                                    ...
                                                    <td>{product.image}</td>
                                                    <td><Link to={`/admincoffee/editproduct/${product.id}`} className="btn btn-sm btn-dark" onClick={() => actions.setCurrentProduct(product)}>Editar</Link>
                                                        <button className="btn btn-sm btn-danger ml-3" onClick={() => actions.deleteProducts(product.id, index)}>Eliminar</button>
                                                    </td>
